...
<div class="site-wrapper">
    ...
    <?php get_template_part('template-parts/segment-headertopmenu.php', 'headertopmenu'); ?>

    <?php get_template_part('template-parts/segment-headermainmenu.php', 'headermainmenu'); ?>
