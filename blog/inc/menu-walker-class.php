...
class Itssportstime_Top_Menu_Walker extends Walker {
    ...
    public function start_el( &$output, $data_object, $depth = 0, $args = null, $current_object_id = 0 ) {
        ...
        $class_names = $class_names ? ' class="d-flex align-items-center ' . esc_attr( $class_names ) . '"' : '';
        ...
        foreach ( $atts as $attr => $value ) {
            if ( is_scalar( $value ) && '' !== $value && false !== $value ) {
                ...
                $attributes .= ' class="nav-link text-danger p-0 mx-2"';
...
class Itssportstime_Social_Menu_Walker extends Walker {
    ...
    public function start_el( &$output, $data_object, $depth = 0, $args = null, $current_object_id = 0 ) {
        ...
        $classes[] = 'menu-item-' . $menu_item->ID;
        $classes = array();
        $classes[] = 'nav-item list-inline-item mx-0';
    ...
    public function start_el( &$output, $data_object, $depth = 0, $args = null, $current_object_id = 0 ) {
        ...
        foreach ( $atts as $attr => $value ) {
            if ( is_scalar( $value ) && '' !== $value && false !== $value ) {
                $value       = ( 'href' === $attr ) ? esc_url( $value ) : esc_attr( $value );
                /**
                 * Adding class for <a> tag or link
                 */
                $attributes .= ' class="nav-link text-white d-flex text-center flex-column"';
                $attributes .= ' ' . $attr . '="' . $value . '"';
            }
        }
